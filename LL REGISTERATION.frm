...
Begin VB.Form Form2 
   ...
   Begin VB.Label Label7 
      Alignment       =   2  'Center
      BackColor       =   &H000080FF&
      Caption         =   "Learning License Registration"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   17.25
         Charset         =   0
   ...
   Begin VB.Label Label1 
      BackColor       =   &H80000005&
      Caption         =   "Select state and RTO office  from where LL  is being applied"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
'creating applicant id'
Dim a As Date
Dim str1, str2 As String
a = Text10.Text
str1 = Format(a, "d")
str2 = Format(a, "yyyy")
res.Fields(23) = str2 + str1
res.Update
MsgBox ("Successfull")
Load Form4
Form4.Height = Screen.Height + 100
Form4.Width = Screen.Height + 500
Form4.Visible = True
Form2.Hide
End Sub
